# -*- coding: utf-8 -*-
"""
Created on Sun May 16 01:43:14 2021

@author: Ahmed

A 3 functions defined to test the API Get/Post functionalities
"""
import json
...
def test_get():
    ...
    assert json.loads(response.text)["Welcome"] == "Welcome to the ML project!"
